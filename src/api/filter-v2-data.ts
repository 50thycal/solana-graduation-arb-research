...
export async function computeFilterV2Data(
  ...
  opts?: { p6Raw?: unknown },
      ...
      const PANEL_1_FILTERS: FilterDef[] = [
        ...
        { name: 'whales <= 5 (measured)',      group: 'Holder Dist', column: 'whale_count_1pct', where: 'whale_count_1pct <= 5 AND holder_count_backfilled = 0',
          predicate: (r) => r.whale_count_1pct != null && r.whale_count_1pct <= 5 && r.holder_count_backfilled === 0 },
        { name: 'whales <= 10 (measured)',     group: 'Holder Dist', column: 'whale_count_1pct', where: 'whale_count_1pct <= 10 AND holder_count_backfilled = 0',
          predicate: (r) => r.whale_count_1pct != null && r.whale_count_1pct <= 10 && r.holder_count_backfilled === 0 },
        ...
        { name: 'holder_sniper_ratio >= 5 (measured)', group: 'Holder Dist', column: 'holder_sniper_ratio', where: 'holder_sniper_ratio >= 5 AND holder_count_backfilled = 0',
          predicate: (r) => r.holder_sniper_ratio != null && r.holder_sniper_ratio >= 5 && r.holder_count_backfilled === 0 },
        { name: 'holder_sniper_ratio >= 10 (measured)', group: 'Holder Dist', column: 'holder_sniper_ratio', where: 'holder_sniper_ratio >= 10 AND holder_count_backfilled = 0',
          predicate: (r) => r.holder_sniper_ratio != null && r.holder_sniper_ratio >= 10 && r.holder_count_backfilled === 0 },
